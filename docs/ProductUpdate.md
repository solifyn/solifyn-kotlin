...
| ------------ | ------------- | ------------- | ------------- |
| **name** | **kotlin.String** | Product display name. |  [optional] |
| **description** | **kotlin.String** | A description of the product. |  [optional] |
| **price** | [**java.math.BigDecimal**](java.math.BigDecimal.md) | Price value. |  [optional] |
| **currency** | [**inline**](#Currency) | Product pricing currency. |  [optional] |
| **imageUrl** | **kotlin.String** | URL of the product cover image. |  [optional] |
| **taxCategory** | [**inline**](#TaxCategory) | Tax classification. |  [optional] |
